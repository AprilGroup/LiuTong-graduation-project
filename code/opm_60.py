# -*- coding: utf-8 -*-
"""
Created on Sat May 12 21:27:01 2018
...
excess_result = pd.read_csv('E:/GraduationProject/excess_result_60.csv')
...
def choose_top_v1(enddate,topn,n,m):
    ...
    excess_result6 = excess_result5.loc[:,['port_code', 'annul_sixty_risk','sixty_sr']]

    excess_choose = excess_result6.sort_values(by='annul_sixty_risk')[0:200].reset_index(drop=True)
    excess_choose1 = excess_choose.sort_values(by='sixty_sr',ascending=False)[0:100].reset_index(drop=True)

    print(excess_choose1)
...
v_frame.to_csv("E:/GraduationProject/60days_v.csv",index=False)
#%%
newnav = pd.DataFrame()
newnav["NavDate"] = changedate
newnav["Nav"] = navlist
newnav.to_csv("E:/GraduationProject/adjweight_60.csv",index=False)
...
def NavCurve(fileaddress):
    ...
    plt.show()
NavCurve("E:/GraduationProject/adjweight_60.csv")
...
#%%
portfolioindex('E:/GraduationProject/adjweight_60.csv')
